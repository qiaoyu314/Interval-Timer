...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Model.model"];
...
//        
//        //add a fake data
//        Timer *timer =[NSEntityDescription insertNewObjectForEntityForName:@"Timer"
//                                                    inManagedObjectContext:context];
//        timer.name = @"Timer 1";
//        timer.roundLength = @20.0;
//        timer.cycle = @5;
//        
//		[context save:NULL];
//	}
