...
class YQCollectionViewController: UICollectionViewController{
    ...
    @IBAction func downloadTimer(sender: YQButtonView) {
        ...
        newTimer.warmUpLength = selectedTimer.warmUpLength!
        newTimer.roundLength = selectedTimer.roundLength!
        newTimer.restLength = selectedTimer.restLength!
        newTimer.cycle = selectedTimer.cycle!
    ...
    func loadTimers(){
        ...
        Alamofire.request(.GET, httpDomain, parameters: param)
